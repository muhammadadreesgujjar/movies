    ...
    <div className="movieBox p-2" onClick={()=>handleBox(id)}>
      <div className="h-4/5 rounded-xl relative">
        ...
        <div className="absolute top-3 right-2">
          <span className="p-2 px-3 rounded-md border-red-500 border-2 mx-2" onClick={(e)=>handleDelete(e,id)}>
          <FontAwesomeIcon icon={faTrash} className="text-red-500" />
          </span>
          <span className="p-2 px-3 rounded-md border-gray-500 border-2 mx-2" onClick={(e)=>handleEdit(e,id)}>
